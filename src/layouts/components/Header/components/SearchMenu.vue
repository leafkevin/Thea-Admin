...
<script setup lang="ts">
  ...
  // 点击菜单跳转
  const handleClickMenu = (menuItem: IMenuRoute | Record<string, any>) => {
    searchMenu.value = "";
    if (menuItem.meta.linkUrl) window.open(menuItem.meta.linkUrl, "_blank");
